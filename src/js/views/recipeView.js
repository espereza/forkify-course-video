/* Later will be a parent class called View, which will contain
 * a couple of methods that all the views should inherit.
*/
...
// any library or package that we import from npm, we don't even have to specify any path only the name

/* We want each view to have a couple of private methods and properties */
class RecipeView extends View {
    _parentElement = document.querySelector('.recipe');
    _errorMessage = 'We could not fing that recipe. Please try another one!';
    _successMessage = '';
    ...
    addHandlerRender(handler) {
        ...
        * We can group the events in order to avoid duplicate code
        */
        ['hashchange', 'load'].forEach(eventt => window.addEventListener(eventt, handler));
    }
